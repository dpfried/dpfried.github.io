...
\item \href{https://arxiv.org/pdf/2405.20253}{\textbf{Evaluating Large Language Model Biases in Person-Steered Generation}} \\
...
\item \href{https://arxiv.org/abs/2301.03988}{\textbf{{SantaCoder}: Don't Reach for the Stars}} \\
...
\item \textbf{{BigCodeBench}: Benchmarking Code Generation with Diverse Function Calls and Complex Instructions} \\
  Terry Yue Zhuo, Vu Minh Chien, Han Hu, Jenny Chim, Wenhao Yu, Ratnadira Widyasari, Imam Nur Bani Yusuf, Haolan Zhan, Junda He, Indraneil Paul, Simon Brunner, Chen GONG, James Hoang, Armel Randy Zebaze, Xiaoheng Hong, Wen-Ding Li, Jean Kaddour, Ming Xu, Zhihan Zhang, Prateek Yadav, Naman Jain, Alex Gu, Zhoujun Cheng, Loubna Ben allal, Qian Liu, Zijian Wang, David Lo, Binyuan Hui, Niklas Muennighoff, \underline{Daniel Fried}, Xiaoning Du, Harm de Vries, Leandro Von Werra\\
  \emph{in preparation}, 2024

\item \textbf{{CodeRAG-Bench}: Can Retrieval Augment Code Generation?} \\
  Zhiruo Wang, Akari Asai, Xinyan Velocity Yu, Frank F. Xu, Yiqing Xie, \underline{Daniel Fried}, Graham Neubig\\
  \emph{in preparation}, 2024
