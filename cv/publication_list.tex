...
\item \textbf{Human-Agent Cooperation in Games under Incomplete Information through Natual Language Communication } \\
...
\item \textbf{Evaluating Large Language Model Biases in Person-Steered Generation} \\
...
\item \href{https://github.com/bigcode-bench/bigcode-bench.github.io/blob/main/paper.pdf}{\textbf{{BigCodeBench}: Benchmarking Code Generation with Diverse Function Calls and Complex Instructions}} \\
...
\item \href{https://arxiv.org/abs/2406.12814}{\textbf{Adversarial Attacks on Multimodal Agents}} \\
  Chen Henry Wu, Jing Yu Koh, Ruslan Salakhutdinov, \underline{Daniel Fried}, and Aditi Raghunathan\\
  \emph{arXiv}, 2024

\item \href{https://jykoh.com/search-agents/paper.pdf}{\textbf{Tree Search for Language Model Agents}} \\
