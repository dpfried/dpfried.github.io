...
%\begin{etaremune}[partopsep=0pt]
  ...
  \item \href{}{\textbf{API-Assisted Code Generation for Question Answering on Arbitrarily Structured Tables}} \\
  ...
  \item \href{}{\textbf{Symbolic Planning and Code Generation for Grounded Dialogue }} \\
    Justin Chiu, Wenting Zhao, Derek Chen, Saujas Vaduguru, Alexander Rush, and \underline{Daniel Fried} \\
    \emph{Empirical Methods in Natural Language Processing (EMNLP)}, 2023

  \item \href{}{\textbf{Pragmatics in Language Grounding: Phenomena, Tasks, and Modeling Approaches}} \\
  ...
  \item \href{}{\textbf{CMTrans: Improving Code Translation with Comparable Corpora and Multiple References}} \\
...
\item \href{http://nlp.cs.berkeley.edu/pubs/Gaddy-Fried-Kitaev-Stern-Corona-DeNero-Klein_2021_TeachingNLP_paper.pdf}{\textbf{Interactive Assignments for Teaching Structured Neural NLP}} \\
  ...
  \item \href{https://arxiv.org/abs/2309.03225}{\textbf{Amortizing Pragmatic Program Synthesis with Rankings}} \\
