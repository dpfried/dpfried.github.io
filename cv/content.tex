...
\begin{itemize}[leftmargin=-0.4mm,partopsep=0pt,label=]
  ...
  \item \poss{Research Scientist}{Meta}{2024 -- present}
    \emph{Areas}: LLM-based coding agents \\
    Currently 20\% time
